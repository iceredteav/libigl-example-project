...
execute_process(
  COMMAND "F:/Git/cmd/git.exe" show-ref v2.5.0
  WORKING_DIRECTORY "F:/libigl-example-project/out/build/x64-Debug/_deps/libigl-src"
...
# yet).
execute_process(
  COMMAND "F:/Git/cmd/git.exe" rev-list --max-count=1 v2.5.0
  WORKING_DIRECTORY "F:/libigl-example-project/out/build/x64-Debug/_deps/libigl-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'F:/libigl-example-project/out/build/x64-Debug/_deps/libigl-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'F:/libigl-example-project/out/build/x64-Debug/_deps/libigl-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
